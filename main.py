...
class JLineEdit(QLineEdit):
    ...
    def isValid(self):
        ...
        try:
            ...
            value = float(json.loads(self.text())['cmt']) + 1 / (self.parent.fps * 10)
...
class SubWindow:
    ...
    def openGithub(self):
        url = 'https://github.com/zugebot/Speedrun-Retimer'
        webbrowser.open(url)
...
class MainWindow(QMainWindow):
    ...
    def initMenuBar(self):
        ...
        _openGithub = QAction(QIcon("git-white.png"), "Github Page", self)
        _openGithub.triggered.connect(self.retimerWindow.openGithub)
        barAbout.addAction(_openGithub)
